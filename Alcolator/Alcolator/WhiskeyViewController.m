...
- (void)buttonPressed:(UIButton *)sender;
{
    ...
    // Show on badge
//    int wholeNumber = ceilf(numberOfWhiskeyGlassesForEquivalentAlcoholAmount);   // round up
    int wholeNumber = numberOfWhiskeyGlassesForEquivalentAlcoholAmount;  // round down
